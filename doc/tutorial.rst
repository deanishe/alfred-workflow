...
:meth:`web.Response.json() <workflow.web.Response.json>` method returns Unicode
(as do most **Alfred-Workflow** methods and functions), and if you used an
...
:ref:`second part of the tutorial <tutorial2>`.
